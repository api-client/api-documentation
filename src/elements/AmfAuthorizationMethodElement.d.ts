...
import { CustomMethodMixin } from './mixins/CustomMethodMixin';
import { PassThroughMethodMixin } from './mixins/PassThroughMethodMixin';
import { ApiOauth1MethodMixin } from './mixins/ApiOauth1MethodMixin';
import { ApiOauth2MethodMixin } from './mixins/ApiOauth2MethodMixin';
import { ApiKeyMethodMixin } from './mixins/ApiKeyMethodMixin';
import { CSSResult } from 'lit-element';
import { ApiParametrizedSecuritySchemeRecursive } from '@api-client/amf-store';
 ...
 */
export default class AmfAuthorizationMethodElement extends PassThroughMethodMixin(CustomMethodMixin(ApiOauth1MethodMixin(ApiOauth2MethodMixin(ApiKeyMethodMixin(AuthorizationMethod))))) {
  get styles(): CSSResult;

  /**
   * A security model generated by the AMF parser.
   */
  security: ApiParametrizedSecuritySchemeRecursive;
  /**
