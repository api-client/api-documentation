...
import { PassThroughAuthorization } from '@advanced-rest-client/arc-types/src/authorization/Authorization';
...
export declare interface PassThroughMethodMixin {
  /**
     ...
     */
    [restorePassThrough](settings: PassThroughAuthorization): void;

    [restoreModelValue](type: string, restored: Record<string, string>): void;

    [serializePassThrough](): PassThroughAuthorization;
