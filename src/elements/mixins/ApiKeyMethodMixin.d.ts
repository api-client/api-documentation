...
import { ApiKeyAuthorization } from "@advanced-rest-client/arc-types/src/authorization/Authorization";
...
export declare interface ApiKeyMethodMixin {
   ...
   */
  [restoreApiKey](settings: ApiKeyAuthorization): void;
   ...
   */
  [serializeApiKey](): ApiKeyAuthorization;
