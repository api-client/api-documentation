...
import { RamlCustomAuthorization } from '@advanced-rest-client/arc-types/src/authorization/Authorization';
...
export declare interface CustomMethodMixin {
  /**
     ...
     */
    [restoreCustom](settings: RamlCustomAuthorization): void;

    [restoreModelValue](type: string, restored: RamlCustomAuthorization): void;

    [clearCustom](): void;

    [serializeCustom](): RamlCustomAuthorization;
